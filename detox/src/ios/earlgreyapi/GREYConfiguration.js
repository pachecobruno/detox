...
*/ static valueForConfigKey(
    element,
    configKey
  ) {
    if (typeof configKey !== 'string')
      throw new Error('configKey should be a string, but got ' + (configKey + (' (' + (typeof configKey + ')'))));
    return {
      target: {
        type: 'Invocation',
        value: element
...
*/ static integerValueForConfigKey(
    element,
    configKey
  ) {
    if (typeof configKey !== 'string')
...
*/ static doubleValueForConfigKey(
    element,
    configKey
  ) {
    if (typeof configKey !== 'string')
...
@param value     The configuration value to be set. Scalars should be wrapped in @c NSValue.
@param configKey Key identifying an existing or new configuration. Must be a valid @c NSString.
*/ static setDefaultValueForConfigKey(
    element,
    value,
    configKey
  ) {
